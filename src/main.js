...
const experationDateMasked = IMask(expirationDate, expirationDatePattern)
...
cardHolder.addEventListener("input", () => {
  const cardHolderValue = document.querySelector(".cc-holder .value")

  cardHolderValue.innerText = cardHolder.value.length === 0 ? "FULANO DA SILVA" : cardHolder.value
})
